...
public class PSParser extends Parser2 {
	...
	private static String[] getUpCards(final Game.Type gametype, final String[] cards) {
		switch (gametype) {
			case STUD:
			case STUDHL:
			case RAZZ:
	...
	private static String[] getHoleCards(final Game.Type gametype, final String[] cards) {
		switch (gametype) {
			case STUD:
			case STUDHL:
			case RAZZ:
